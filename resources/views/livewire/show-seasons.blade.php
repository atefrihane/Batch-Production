    ...
    <div class="card">
        ...
        <div class="card-body">
                                ...
                                <div class="dropdown d-flex justify-content-center">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item"
                                            href="{{route('showUpdateSeason',$season->id)}}">Edit</a>
                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                            data-target="#exampleModal{{$season->id}}">Delete</a>
                                    </div>
                                </div>

                                <!-- Modal -->
                                <div class="modal fade" id="exampleModal{{$season->id}}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary"
                                                    wire:click="handleDeleteSeason({{$season->id}})"
            ...
            <div>
                ...
                <p class="mt-4">
                    Showing {{$seasons->firstItem()}} to {{$seasons->lastItem()}} out of {{$seasons->total()}}
                    seasons
                </p>
