<div>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <h3 class="text-center mb-5">Room 1 management </h3>
            <div class="row mb-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center">
                                <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($batch->id, 'C39')}}" alt="barcode" />
                            </td>
                            <td>{{$batch->children_count}}</td>
                            ...
                            <td>
                                <div class="dropdown d-flex justify-content-center"  >
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"  >
                                        ...
                                        href="{{route('showSubstractBatch',$batch->id)}}">Substract </a>
                                      
                                            <a class="dropdown-item" href="{{route('showBatchToPrint',$batch->id)}}">Print</a>
                                        @permit('firstStep')
                                        <a class="dropdown-item" href="{{route('showUpdateBatchRoomOne',$batch->id)}}">Edit</a>
