<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <h1 class="text-center mb-5">Room 1</h1>
            ...
            <div class="table-responsive">
                <table class="table  table-bordered table-hover " style="width:100%">
                    ...
                    <tbody>
                        ...
                        @foreach ($firstRoomBatches as $batch)
                ...
                <div>
                    <div>
                        ...
                        <p class="mt-4">
                            Showing {{$firstRoomBatches->firstItem()}} to {{$firstRoomBatches->lastItem()}} out of {{$firstRoomBatches->total()}}
                            firstRoomBatches
                        </p>
                        <div class="d-flex justify-content-center">


                            {{$firstRoomBatches->links()}}
