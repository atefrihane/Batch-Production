<div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <h1 class="text-center mb-5">Room 2</h1>
                ...
                <div class="table-responsive">
                    <table class="table  table-bordered table-hover " style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($secondRoomBatches as $batch)
                    ...
                    <div>
                        <div>
                            ...
                            <p class="mt-4">
                                Showing {{$secondRoomBatches->firstItem()}} to {{$secondRoomBatches->lastItem()}} out of {{$secondRoomBatches->total()}}
                                secondRoomBatches
                            </p>
                            <div class="d-flex justify-content-center">
    
    
                                {{$secondRoomBatches->links()}}
